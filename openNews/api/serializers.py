...
from .models import Section, Article, Account, Comment
...
class UserCreateSerializer(ModelSerializer):
    ...
    class Meta:
        model = User
        fields = ('username', 'email', 'email2', 'first_name', 'last_name', 'password')
...
class AccountSerializer(ModelSerializer):
    ...
    phone_number = CharField(validators=[phone_regex], max_length=15, allow_null=True)  # validators should be a list
...
class CommentSerializer(ModelSerializer):
    ...
    class Meta:
        model = Comment
        fields = ('user', 'content', 'like', 'dislike')
